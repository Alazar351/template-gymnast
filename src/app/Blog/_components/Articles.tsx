        ...
        <Pagination>
          <PaginationContent className="gap-0 ">
            <PaginationItem className="flex items-center justify-center">
              <PaginationPrevious
                href="#"
                className="pointer-events-none w-[34px] rounded-none border p-0 text-[#666]"
              />
            </PaginationItem>
            <PaginationItem className="">
              <PaginationLink
                href="#"
                isActive
                className="w-[32px] rounded-none border border-[[#e31c25]] bg-[#e31c25] text-white hover:bg-[#e31c25] hover:text-white"
              >
                1
              </PaginationLink>
            </PaginationItem>
            <PaginationItem className="text-[#e31c25]">
              <PaginationLink href="#" className="w-[32px] rounded-none border">
                2
              </PaginationLink>
            </PaginationItem>
            <PaginationItem className="text-[#e31c25]">
              <PaginationLink
                href="#"
                className="w-[32px] rounded-none border-b border-t"
              >
                3
              </PaginationLink>
            </PaginationItem>
            <PaginationItem className="text-[#e31c25]">
              <PaginationNext
                href="#"
                className="w-[34px] rounded-none border p-0"
              />
            </PaginationItem>
          </PaginationContent>
        </Pagination>
